    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.row_1_sv_1:
                int isLogin_row_1_col_1 = device_row_1_col_1.getLoginID();
...
//                    Button btn_Login = (Button) view.findViewById(R.id.btn_login);
                ...
                break;
            case R.id.row_2_sv_1:
                int isLogin_row_2_col_1 = device_row_2_col_1.getLoginID();
...
//                                return;
                            ...
                            //5.开始登陆
                            int port = Integer.parseInt(portString);
                            cameradevice_row_2_col_1.setIp(ip);
                            cameradevice_row_2_col_1.setUsername(username);
                            cameradevice_row_2_col_1.setPassword(password);
                            cameradevice_row_2_col_1.setPort(port);
                            ...
                            //将登陆信息初始化
                            device_row_2_col_1.setPara(cameradevice_row_2_col_1);

                            //设置播放容器
                            device_row_2_col_1.setHolder(mrow_2_sv_1.getHolder());
                            ...
                            //设置错误回调函数
                            device_row_2_col_1.setExceptionCallBack();

                            //开始预览
                            device_row_2_col_1.startSinglePreview();
...
//                    Button btn_Login = (Button) view.findViewById(R.id.btn_login);
                    ...
                    customDialog.setTitle("提示").setMessage("是否登出 ?")
                        ...
                        public void onConfirm(CustomDialog customDialog) {
                            ...
                            //登出操作
                            device_row_2_col_1.stopPlay();

                            device_row_2_col_1.logoutDevice();

                            device_row_2_col_1.freeSDK();

                            //这里将两个实例置为null，GC回收。反正也不用了
                            /*device_row_2_col_1 = null;
                            cameradevice_row_2_col_1 = null;*/
            ...
            case R.id.row_2_sv_2:
                int isLogin_row_2_col_2 = device_row_2_col_2.getLoginID();
...
//                                return;
                            ...
                            //5.开始登陆
                            int port = Integer.parseInt(portString);
                            cameradevice_row_2_col_2.setIp(ip);
                            cameradevice_row_2_col_2.setUsername(username);
                            cameradevice_row_2_col_2.setPassword(password);
                            cameradevice_row_2_col_2.setPort(port);
                            ...
                            //将登陆信息初始化
                            device_row_2_col_2.setPara(cameradevice_row_2_col_2);

                            //设置播放容器
                            device_row_2_col_2.setHolder(mrow_2_sv_2.getHolder());
                            ...
                            //设置错误回调函数
                            device_row_2_col_2.setExceptionCallBack();

                            //开始预览
                            device_row_2_col_2.startSinglePreview();
...
//                    Button btn_Login = (Button) view.findViewById(R.id.btn_login);
                    ...
                    customDialog.setTitle("提示").setMessage("是否登出 ?")
                        ...
                        public void onConfirm(CustomDialog customDialog) {
                            ...
                            //登出操作
                            device_row_2_col_2.stopPlay();

                            device_row_2_col_2.logoutDevice();

                            device_row_2_col_2.freeSDK();
                ...
                break;
            case R.id.row_2_sv_3:
                int isLogin_row_2_col_3 = device_row_2_col_3.getLoginID();
...
//                                return;
                            ...
                            //5.开始登陆
                            int port = Integer.parseInt(portString);
                            cameradevice_row_2_col_3.setIp(ip);
                            cameradevice_row_2_col_3.setUsername(username);
                            cameradevice_row_2_col_3.setPassword(password);
                            cameradevice_row_2_col_3.setPort(port);
                            ...
                            //将登陆信息初始化
                            device_row_2_col_3.setPara(cameradevice_row_2_col_3);

                            //设置播放容器
                            device_row_2_col_3.setHolder(mrow_2_sv_3.getHolder());
                            ...
                            //设置错误回调函数
                            device_row_2_col_3.setExceptionCallBack();

                            //开始预览
                            device_row_2_col_3.startSinglePreview();
...
//                    Button btn_Login = (Button) view.findViewById(R.id.btn_login);
                    ...
                    customDialog.setTitle("提示").setMessage("是否登出 ?")
                        ...
                        public void onConfirm(CustomDialog customDialog) {
                            ...
                            //登出操作
                            device_row_2_col_3.stopPlay();

                            device_row_2_col_3.logoutDevice();

                            device_row_2_col_3.freeSDK();
                ...
                break;
            case R.id.row_3_sv_1:
                int isLogin_row_3_col_1 = device_row_3_col_1.getLoginID();
...
//                                return;
                            ...
                            //5.开始登陆
                            int port = Integer.parseInt(portString);
                            cameradevice_row_3_col_1.setIp(ip);
                            cameradevice_row_3_col_1.setUsername(username);
                            cameradevice_row_3_col_1.setPassword(password);
                            cameradevice_row_3_col_1.setPort(port);
                            ...
                            //将登陆信息初始化
                            device_row_3_col_1.setPara(cameradevice_row_3_col_1);

                            //设置播放容器
                            device_row_3_col_1.setHolder(mrow_3_sv_1.getHolder());
                            ...
                            //设置错误回调函数
                            device_row_3_col_1.setExceptionCallBack();

                            //开始预览
                            device_row_3_col_1.startSinglePreview();
...
//                    Button btn_Login = (Button) view.findViewById(R.id.btn_login);
                    ...
                    customDialog.setTitle("提示").setMessage("是否登出 ?")
                        ...
                        public void onConfirm(CustomDialog customDialog) {
                            ...
                            //登出操作
                            device_row_3_col_1.stopPlay();

                            device_row_3_col_1.logoutDevice();

                            device_row_3_col_1.freeSDK();
                ...
                break;
            case R.id.row_3_sv_2:
                int isLogin_row_3_col_2 = device_row_3_col_2.getLoginID();
...
//                                return;
                            ...
                            //5.开始登陆
                            int port = Integer.parseInt(portString);
                            cameradevice_row_3_col_2.setIp(ip);
                            cameradevice_row_3_col_2.setUsername(username);
                            cameradevice_row_3_col_2.setPassword(password);
                            cameradevice_row_3_col_2.setPort(port);
                            ...
                            //将登陆信息初始化
                            device_row_3_col_2.setPara(cameradevice_row_3_col_2);

                            //设置播放容器
                            device_row_3_col_2.setHolder(mrow_3_sv_2.getHolder());
                            ...
                            //设置错误回调函数
                            device_row_3_col_2.setExceptionCallBack();

                            //开始预览
                            device_row_3_col_2.startSinglePreview();
...
//                    Button btn_Login = (Button) view.findViewById(R.id.btn_login);
                    ...
                    customDialog.setTitle("提示").setMessage("是否登出 ?")
                        ...
                        public void onConfirm(CustomDialog customDialog) {
                            ...
                            //登出操作
                            device_row_3_col_2.stopPlay();

                            device_row_3_col_2.logoutDevice();

                            device_row_3_col_2.freeSDK();
                ...
                break;
            case R.id.row_3_sv_3:
                int isLogin_row_3_col_3 = device_row_3_col_3.getLoginID();
...
//                                return;
                            ...
                            //5.开始登陆
                            int port = Integer.parseInt(portString);
                            cameradevice_row_3_col_3.setIp(ip);
                            cameradevice_row_3_col_3.setUsername(username);
                            cameradevice_row_3_col_3.setPassword(password);
                            cameradevice_row_3_col_3.setPort(port);
                            ...
                            //将登陆信息初始化
                            device_row_3_col_3.setPara(cameradevice_row_3_col_3);

                            //设置播放容器
                            device_row_3_col_3.setHolder(mrow_3_sv_3.getHolder());
                            ...
                            //设置错误回调函数
                            device_row_3_col_3.setExceptionCallBack();

                            //开始预览
                            device_row_3_col_3.startSinglePreview();
...
//                    Button btn_Login = (Button) view.findViewById(R.id.btn_login);
                    ...
                    customDialog.setTitle("提示").setMessage("是否登出 ?")
                        ...
                        public void onConfirm(CustomDialog customDialog) {
                            ...
                            //登出操作
                            device_row_3_col_3.stopPlay();

                            device_row_3_col_3.logoutDevice();

                            device_row_3_col_3.freeSDK();
