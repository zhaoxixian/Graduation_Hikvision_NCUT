...
/**
 * 在test5activity的基础上，加入退出的点击事件（同时释放资源）
 */
...
//        cameradevice.setChannel();
        ...
        switch (v.getId()) {
            case R.id.row_1_sv_1:
                ...
                if (m_iLogID < 0) {//-1
                    ...
                    View view = LayoutInflater.from(Test6Activity.this).inflate(R.layout.layout_dialog, null);
                    ...
                    btn_Login.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            ToastUtil.showMsg2(Test6Activity.this, "登陆了");
                            alertDialog.dismiss();
                        }
                    });*/
            ...
            case R.id.row_1_sv_2:
                CustomDialog customDialog = new CustomDialog(Test6Activity.this, R.style.CustomDialog);
                customDialog.setTitle("提示").setMessage("是否登出 ?")
                        .setCancel("取消", new CustomDialog.IOnCancelListener() {
                            @Override
                            public void onCancel(CustomDialog customDialog) {
                                ToastUtil.showMsg2(Test6Activity.this, "Cancel……");
                    ...
                    public void onConfirm(CustomDialog customDialog) {
                        ...
                        ToastUtil.showMsg2(Test6Activity.this, "登出成功啦!");
    ...
    private void riskAuthorization() {
        ...
        */
        ...
        //检查是否获得了权限
        if (ContextCompat.checkSelfPermission(Test6Activity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
            permissionList.add(Manifest.permission.WRITE_EXTERNAL_STORAGE);
        }
        if (ContextCompat.checkSelfPermission(Test6Activity.this, Manifest.permission.CAPTURE_AUDIO_OUTPUT) != PackageManager.PERMISSION_GRANTED) {
            permissionList.add(Manifest.permission.CAPTURE_AUDIO_OUTPUT);
        }
        if (ContextCompat.checkSelfPermission(Test6Activity.this, Manifest.permission.RECORD_AUDIO) != PackageManager.PERMISSION_GRANTED) {
            permissionList.add(Manifest.permission.RECORD_AUDIO);
        }
        if (!permissionList.isEmpty()) {
            String[] permissions = permissionList.toArray(new String[permissionList.size()]);
            ActivityCompat.requestPermissions(Test6Activity.this, permissions, 1);
            //申请权限
            //开始弹出授权信息，并决定是否同意，之后会调onRequestPermissionsResult()回调
        } else {
            // TODO: 2019/4/17
            ToastUtil.showMsg2(Test6Activity.this, "授权成功了");
        }
    }
...
//        super.onBackPressed();
        ...
        if (lastClickTime <= 0) {
            ...
            if (currentClickTime - lastClickTime < 1000) {
                ...
                ToastUtil.showMsg2(Test6Activity.this, "资源已回收,再会了!");
